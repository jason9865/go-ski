...
class CheckInstructorScreen extends StatefulWidget {
  const CheckInstructorScreen({super.key});

  @override
  State<CheckInstructorScreen> createState() => _CheckInstructorScreen();
}

class _CheckInstructorScreen extends State<CheckInstructorScreen> {
