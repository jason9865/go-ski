...
public class OauthMemberClientComposite {
    ...
    public User fetch(OauthServerType oauthServerType, String role, String authCode, String accessToken) {
        return getClient(oauthServerType).fetch(role, authCode, accessToken);
    }
