...
class BossTeamScheduleScreen extends StatefulWidget {
  const BossTeamScheduleScreen({super.key});

  @override
  State<BossTeamScheduleScreen> createState() => _BossTeamScheduleScreen();
}

class _BossTeamScheduleScreen extends State<BossTeamScheduleScreen> {
              ...
              Row(
                ...
                children: [
                  GoskiMiddlesizeButton(
                    ...
                    text: tr('teamMemberList'),
                    onTap: () => logger.d("팀원 목록"),
                  ),
                  GoskiMiddlesizeButton(
                    width: screenSizeController.getWidthByRatio(0.9),
                    text: tr('updateTeamInfo'),
                    onTap: () => logger.d("팀 정보 수정"),
                  ),
                  GoskiMiddlesizeButton(
                    width: screenSizeController.getWidthByRatio(0.9),
                    text: tr('lessonList'),
                    onTap: () => logger.d("강습 목록"),
                  ),
                ],
              ),
            ],
