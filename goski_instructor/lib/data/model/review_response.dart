...
class ReviewResponse {
  ...
  @override
  String toString() {
    return 'ReviewResponse{reviewId: $reviewId, lessonId: $lessonId, lessonDate: $lessonDate, lessonTime: $lessonTime, representativeName: $representativeName, rating: $rating, content: $content, createdAt: $createdAt, instructorTags: $instructorTags}';
  }
}
...
extension ReviewListResponseToReviewList on ReviewResponse {
  Review toReviewList() {
    return Review(
      reviewId: reviewId,
      lessonId: lessonId,
